...
function AuthErrorContent() {
  ...
  return (
    <div style={{ background: "linear-gradient(135deg, rgba(59, 130, 246, 0.05) 0%, rgba(147, 51, 234, 0.03) 100%)", minHeight: "100vh" }}>
      <div className="container" style={{ paddingBottom: "100px", minHeight: "100vh", display: "flex", alignItems: "center" }}>
        <div style={{ maxWidth: "500px", margin: "0 auto", textAlign: "center" }}>
          
          <div style={{ width: 80, height: 80, borderRadius: "50%", background: "rgba(239, 68, 68, 0.1)", border: "2px solid rgba(239, 68, 68, 0.3)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 28px", color: "#ef4444" }}>
          ...
          {error && (
            <div style={{ padding: "12px 16px", marginBottom: "24px", background: "rgba(239, 68, 68, 0.08)", border: "1px solid rgba(239, 68, 68, 0.2)", borderRadius: "8px", color: "#ef4444", fontSize: "0.85rem", fontFamily: "monospace" }}>
              Error: {error}
            </div>
          )}
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <button onClick={() => window.location.href = "/"} className="btnOutline">
              Try Again
            </button>
          </div>
